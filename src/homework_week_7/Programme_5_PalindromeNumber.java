...
public class Programme_5_PalindromeNumber {
    public static void main(String[] args) {
        ...
        System.out.println("Enter a number: ");// print the statement user can enter a number
        int number =scanner.nextInt();//integer input
        System.out.println(isPalindrome(number));//calculate and print the palindrome number

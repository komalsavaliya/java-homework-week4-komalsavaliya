...
public class Programme_18_SimpleCalculator {
    ...
    //Method to get the value of both the fields
    ...
    //Method to set the value of the both fields
    ...
    //Method to get the addition result of both numbers
    public double getAdditionResult() {
        return firstNumber + secondNumber;
    }

    //Method to get the subtraction result of both numbers
    public double getSubtractionResult() {
        return firstNumber - secondNumber;
    }

    //Method to get the Multiplication result of both numbers
    public double getMultiplicationResult() {
        return firstNumber * secondNumber;
    }

    //Method to get the Division result of both numbers

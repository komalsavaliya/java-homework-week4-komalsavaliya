...
public class Rectangle {
    //Instance variable to store width and length of rectangle
    ...
    public double getWidth() {
        return width;//Getter method to retrieve the value of the width
    }

    public double getLength() {
        return length;//Getter method to retrieve the value of the length
    }

    public double getArea() {
        return width * length;//Method to calculate and return the area of the rectangle
    }
}
